...
static bool StringInputCallback(void* id, char* str, void* data)
{
	data = str;
	return true;
}
...
MGROUP_ROTATE oMMU_PB::trans_Relevator(0, &GRP_RWING, 1, RWING_REF, RWING_AXIS, ELEVATOR_RANGE);
...
// --------------------------------------------------------------
void oMMU_PB::clbkSetClassCaps(FILEHANDLE cfg)
{
...
void oMMU_PB::clbkSaveState(FILEHANDLE scn)
{
...
bool oMMU_PB::clbkDrawHUD(int mode, const HUDPAINTSPEC* hps, oapi::Sketchpad* skp)
{
	CString cbuf;
	auto lhs = hps->W * 0.1;
	auto top = hps->H * 0.3;
